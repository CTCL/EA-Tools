...
def getVIPValues(data):
  ...
  if 'pollingLocations' in data:
    ...
    if 'line3' in values:
      line3 = values['line3']
    address  = '{0} {1} {2} {4}, {5} {6}'.format(values['line1'], 
      line2, line3, values['city'], values['state'], 
      values['zip']).replace('   ', ' ').replace('  ', ' ')
  ...
  if 'earlyVoteSites' in data:
    ...
    for place in evInfo:
      ...
      address += '{0} {1} {2}, {3} {4}'.format(addressValues['line1'], 
        line2, line3, addressValues['city'], addressValues['state'], 
        addressValues['zip']).replace('   ', ' ').replace('  ', ' ').replace(';',
        '\;')
